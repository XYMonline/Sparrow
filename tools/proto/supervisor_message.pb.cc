...
const uint32_t TableStruct_supervisor_5fmessage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::message_type::route_supervisor, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::message_type::route_supervisor, _impl_.category_),
  PROTOBUF_FIELD_OFFSET(::message_type::route_supervisor, _impl_.server_list_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::message_type::srever_info)},
  { 10, -1, -1, sizeof(::message_type::route_supervisor)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::message_type::_srever_info_default_instance_._instance,
  &::message_type::_route_supervisor_default_instance_._instance,
};

const char descriptor_table_protodef_supervisor_5fmessage_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\030supervisor_message.proto\022\014message_type"
  ...
  "type.route_supervisor_category\022.\n\013server"
  "_list\030\002 \003(\0132\031.message_type.srever_info*\?"
  "\n\031route_supervisor_category\022\017\n\013SERVER_LI"
...
const ::_pbi::DescriptorTable descriptor_table_supervisor_5fmessage_2eproto = {
    false, false, 405, descriptor_table_protodef_supervisor_5fmessage_2eproto,
...
route_supervisor::route_supervisor(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:message_type.route_supervisor)
}
route_supervisor::route_supervisor(const route_supervisor& from)
  ...
  // @@protoc_insertion_point(copy_constructor:message_type.route_supervisor)
}
...
route_supervisor::~route_supervisor() {
  // @@protoc_insertion_point(destructor:message_type.route_supervisor)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:message_type.route_supervisor)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          uint64_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          _internal_set_category(static_cast<::message_type::route_supervisor_category>(val));
        } else
          goto handle_unusual;
        continue;
...
uint8_t* route_supervisor::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:message_type.route_supervisor)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:message_type.route_supervisor)
  return target;
}

size_t route_supervisor::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:message_type.route_supervisor)
  size_t total_size = 0;
...
void route_supervisor::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:message_type.route_supervisor)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:message_type.route_supervisor)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::message_type::route_supervisor*
Arena::CreateMaybeMessage< ::message_type::route_supervisor >(Arena* arena) {
  return Arena::CreateMessageInternal< ::message_type::route_supervisor >(arena);
}
